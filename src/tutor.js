// Handles POST /api/tutor  { token, grade, messages }
// Proxies chat messages to the Claude API so the Anthropic key never
// reaches the browser. Requires a valid signed session token from
// otp-verify.js — email/phone come from the token, never trusted raw
// from the client.
